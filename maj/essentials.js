...
export function intouch() { 
 ...
 return `<ul>${gen(json)}</ul>`;}

export function about() { 
 return meta(`${logoset()}`,`<p>Ifitztrue is one of the best scifi n paranormal activity investigation site to help many people like us to learn about latest technologies being used in paranormal activity n also provide shoppingfor ur fav instuments</p>`);}
...
export function newsletter() { 
 return meta("Newsletter",`<form action="#"><p>Subscribe to our newsletter to get our latest news.</p><input type="text" placeholder="Full Name" name="name" required><input type="email" name="mail" placeholder="Enter email address" required><input type="submit" value="Subscribe"></form>`);}
