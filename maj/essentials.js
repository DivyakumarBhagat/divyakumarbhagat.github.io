...
function site() {return 'if Itz True';}
function logoset() { return `<img src="https://flexbox.ninja/assets/images/logo.svg" alt="${site()} Logo"><a href="#">${site()}</a>`; }
...
export function endfooter() { 
 return met("",`<p>copyright &copy; 2021-2022 <a href='/'>${site()}</a>. All Rights Reseverd</p>`);}
